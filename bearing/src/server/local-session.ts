...
const NATIVE_HTML =
  ...
  '<style>html{zoom:1.2}.demo-panel{background:rgba(15,16,17,.35);-webkit-backdrop-filter:blur(6px);backdrop-filter:blur(6px)}</style>\n' +
  "</head>\n" +
  "<body>\n" +
