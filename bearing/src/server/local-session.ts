...
const NATIVE_HTML =
  ...
  '<style>.demo-panel{background:rgba(15,16,17,.68);-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px)}@media(max-width:760px){.demo-panel{background:rgba(15,16,17,.84)}}</style>\n' +
  "</head>\n" +
  "<body>\n" +
