...
const NATIVE_HTML =
  ...
  '  document.getElementById("demo-next").addEventListener("click", function () { if (demoStage === 2 && !demoMode) { document.getElementById("demo-mode-status").textContent = "Choose Explorer or Expedition before continuing."; return; } if (demoStage === 3) { closeDemoPanel(); return; } showDemoStage(demoStage + 1); });\n' +
