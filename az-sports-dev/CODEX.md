# AlphaZede Sports Developer Instructions - Codex
...
- Never place API keys in committed files, code comments, issue text, public examples, or user-visible messages.
...
- Read AGENTS.md first; CODEX.md repeats the same public rules with Codex-specific context.
- Use `rg` for repository searches when it is available, then run the validation commands listed in README.md.
