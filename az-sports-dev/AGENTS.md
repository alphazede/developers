# AlphaZede Sports Developer Instructions - All Coding Agents
...
- Use this file as the default entry point when no tool-specific file applies.
- If a tool-specific mirror exists, read it after this file; the core rules are the same.
