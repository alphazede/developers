# AlphaZede Sports Developer Instructions - Gemini
...
- Use this mirror with AGENTS.md when working in Gemini-capable coding tools.
- Keep endpoint, package, and host assumptions grounded in the checked-in public files.
